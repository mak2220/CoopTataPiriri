...
const Footer = () => {
    return (
        <>
            <div className='wave bg-black'>
                <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8 wave">
                    ...
                    <p className="mt-8 text-base leading-6 text-center text-gray-400">
                        © 2023 Tatá Piriri Limitada. Todos los derechos reservados
                    </p>
                </div>
            </div>
